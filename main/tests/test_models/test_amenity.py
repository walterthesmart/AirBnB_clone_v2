...
class test_inherit_basemodel(unittest.TestCase):
    """Tests to check that user inherits from BaseModel"""
    def test_instance(self):
        """Checks to see if user is an instance of BaseModel"""
        user = Amenity()
...
class test_Amenity_BaseModel(unittest.TestCase):
    ...
    def test_save_method(self, mock_storage):
        """Tests the save method and if it updates"""
        instance5 = Amenity()
...
class TestAmenity(unittest.TestCase):
    ...
    def test_is_subclass(self):
        """Tests to check that Amenity is a subclass of BaseModel"""
        amenity = Amenity()
    ...
    def test_name_attr(self):
        """Tests to check that Amenity has attribute name, and it's as an empty string"""
        amenity = Amenity()
    ...
    def test_to_dict_creates_dict(self):
        """Teststo check that to_dict method creates a dictionary with proper attrs"""
        am = Amenity()
        print(am.__dict__)
        new_d = am.to_dict()
    ...
    def test_to_dict_values(self):
        """Tests to check that values in dict returned from to_dict are correct"""
    ...
    def test_str(self):
        """Tests to check that the str method has the correct output"""
        amenity = Amenity()
