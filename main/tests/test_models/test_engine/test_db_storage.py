...
"""
This test script contains the TestDBStorageDocs and TestDBStorage classes
"""
...
class TestDBStorageDocs(unittest.TestCase):
    ...
    def test_pep8_conformance_test_db_storage(self):
        """Tests that tests/test_models/test_db_storage.py conforms to PEP8."""
        pep8s = pycodestyle.StyleGuide(quiet=True)
...
test_db_storage.py'])
    ...
    def test_dbs_func_docstrings(self):
        """Tests for the presence of docstrings in the DBStorage methods"""
...
class TestFileStorage(unittest.TestCase):
    ...
    @unittest.skipIf(storage_t != 'db', "not testing db storage")
    def test_new(self):
        """Testss that new adds an object to the database"""
